...
void entertainment_list_in_received_handler(DictionaryIterator *iter) {
  ...
  if (status_tuple && name_tuple && index_tuple && id_tuple) {
...
// Free vector and reset menulayer
...
static void initialise_ui(void) {
  ...
  get_entertainment(park_name);
}

// Free memory of all UI components
...
// Show window
void show_entertainment_list(char *park) {
  park_name = park;
  initialise_ui();
...
// Hide window
void hide_entertainment_list(void) {
